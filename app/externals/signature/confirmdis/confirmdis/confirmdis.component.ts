...
@Component({
  selector: 'app-confirmdis',
  templateUrl: './confirmdis.component.html',
  styleUrls: ['./confirmdis.component.scss']
})
export class ConfirmdisComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      this._SignatureService.getUrlConfirmDis(this.id, this.nom, this.prenom, this.mail, this.tel)
      .subscribe(data => {
        ...
        this.urlDownloadDoc = this.urlViewDoc+"/INSIDERS/rest/dis/downloadDoc/"+this.id;
         ...
         let mailModele={
          ...
          <table> \
            ...
            <tr>\
              <td>\
              <table width='100%'><tr><td style='width:30%;background:#fff;'></td><td style='width:30%;background:#000;'> <div> <a style='text-decoration:none; color:#FFFFFF;' href='"+this.urlDownloadDoc+"'> Consulter le document </a></div> </td><td  style='width:30%;background:#fff;'></td></tr></table>\
              </td> \
            </tr> \
          </table> \
          <table> \
