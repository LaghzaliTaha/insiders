...
import { Initieoccasionnel } from '../../../users/interfaces/initieoccasionnel.model';
...
import { NewUser } from '../../../users/interfaces/new-user.model';
...
@Component({
  selector: 'app-list-initie',
  templateUrl: './list-initie.component.html',
  styleUrls: ['./list-initie.component.scss']
})
export class ListInitieComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._referentsService.getInitOcassByIdRef(this._referentsService.idRef).subscribe(listUsers => {
...
public getInitieOccaByPilote() {
  ...
  //_referentsService.getDisByCorrespondant(this._referentsService.idRef)
    this._referentsService.getInitOcassByIdRef(this._referentsService.idRef)
    .subscribe(data => {
